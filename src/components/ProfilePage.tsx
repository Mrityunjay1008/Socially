...
type LikedPost = LikedPosts[number]
...
const ProfilePage = ({
    ...
    const [isFollowing,setIsFollowing] = React.useState(isCurrentUserFollowing)
    const [isUpdatingFollow,setUpdateFollowing] = React.useState(false)
        ...
        <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
          <DialogContent className="sm:max-w-125">
            ...
            <div className="flex justify-end gap-3">
              <DialogClose className="inline-flex items-center justify-center rounded-lg border text-sm font-medium h-8 px-2.5 hover:bg-accent transition-colors">
  Close
</DialogClose>
